...
<template>
  <footer class="styles_footer__RBpyk">
    ...
    <div class="styles_social__ptL3p">
      <a class="styles_twitter__3YoqL" href="https://twitter.com/transitive_bs" title="Twitter @transitive_bs" target="_blank" rel="noopener noreferrer">
      ...
      <a class="styles_github__0JN7a" href="https://github.com/transitive-bullshit" title="GitHub @transitive-bullshit" target="_blank" rel="noopener noreferrer">
      ...
      <a class="styles_linkedin__bgwDi" href="https://www.linkedin.com/in/fisch2" title="LinkedIn Travis Fischer" target="_blank" rel="noopener noreferrer">
...
.styles_loadingIcon__cjsDo {
	-webkit-animation:styles_spinner__YFmQJ .6s linear infinite;
	animation:styles_spinner__YFmQJ .6s linear infinite;
	display:block;
	width:24px;
	height:24px;
...
.styles_settings__GyEhi,.styles_social__ptL3p {
	-webkit-user-select:none;
	-moz-user-select:none;
	-ms-user-select:none;
	user-select:none
}
.styles_settings__GyEhi a,.styles_social__ptL3p a {
	cursor:pointer;
	font-size:2em;
	display:inline-flex;
	padding:.25em;
...
.styles_settings__GyEhi a:last-of-type,.styles_social__ptL3p a:last-of-type {
	margin-right:0
}
.styles_settings__GyEhi a:hover,.styles_social__ptL3p a:hover {
	transition:color 50ms ease-out
}
.styles_toggleDarkMode__QfgK_:hover,.styles_twitter__3YoqL:hover {
	color:#2795e9
}
...
@media (max-width:1360px) {
	...
	-webkit-animation:styles_octocat-wave__UeRXj .56s ease-in-out;
	animation:styles_octocat-wave__UeRXj .56s ease-in-out
}
@-webkit-keyframes styles_octocat-wave__UeRXj {
	0%,to {
	transform:rotate(0)
}
20%,60% {
